(function (suppliez, $, ko, moment) {
    ...
    //登录页面viewmodel
    suppliez.ViewModels.VendorListViewModel = function () {
        var root = this;
    ...
    suppliez.ViewModels.VendorListViewModel.extend(suppliez.ViewModels.BaseViewModel);
    suppliez.ViewModels.VendorListViewModel.prototype.pageSize = suppliez.config.pageSize;

    suppliez.ViewModels.VendorListViewModel.prototype.getData = function (index) {
        var root = this;
        root.loading();

        index = index || root.all.pageIndex();
        var offset = (index - 1) * root.pageSize;
        return suppliez.service.getMetabaseData(suppliez.config.vendorListUrl, {
            offset: offset,
            rows: root.pageSize
    ...
    suppliez.ViewModels.VendorListViewModel.prototype.init = function () {
        var root = this;
        this.tab("all");
        this.getData();
